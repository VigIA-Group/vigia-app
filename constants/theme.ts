...
export const Fonts = Platform.select({
  ios: {
    ...
    rounded: "PlusJakartaSans_600SemiBold",
  ...
  web: {
    ...
    rounded: "'Plus Jakarta Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif",
